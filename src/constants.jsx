...
v${version}`}</pre>
  ...
  [
    <div key="help-message" className="font-bold">
      Type <span className="terminal-highlight">&quot;help&quot;</span> to see
...
export const hiddenResponses = {
  ...
  akiflow: [
    <a
      key="akiflowReferral"
      target="_blank"
      href="https://web.akiflow.com/referral?name=SmFzcGVy&referral=7qCFeRNE9olhCymwEjz3iv81NsXiYU"
      className="link"
    >
      akiflow.com/referral
    </a>,
  ],
};
